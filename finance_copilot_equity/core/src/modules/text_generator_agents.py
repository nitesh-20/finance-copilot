...
def generate_text_section(data: Dict, prompt_type: str, api_key: str, company_name: str, company_ticker: str, base_url: str = None, model: str = None) -> str:
    ...
    # Validate API key
    if not api_key:
        raise ValueError(f"OpenAI API key is missing. Cannot generate '{prompt_type}' in production mode.")
    ...
    try:
        ...
        if generated_text:
            ...
            raise ValueError(f"Empty response from OpenAI API for '{prompt_type}'")
