    ...
    <div class="max-w-4xl mx-auto px-6 pb-12" style="margin-top: -1rem;">
        ...
        <section class="mt-12" id="disclaimer" style="background: #f8fafc; margin-left: -1.5rem; margin-right: -1.5rem; padding: 1.5rem; border-radius: 0.75rem;">
            <div class="flex items-center gap-2 mb-2">
                <span style="background: linear-gradient(90deg, #6366f1, #8b5cf6); -webkit-background-clip: text; -webkit-text-fill-color: transparent; font-weight: 600; font-size: 0.75rem;">Powered by Finance Copilot AI</span>
...
def render_professional_html_report(data: dict) -> str:
    ...
    report_data = {
        ...
        'research_source': data.get('research_source', 'Finance Copilot'),
