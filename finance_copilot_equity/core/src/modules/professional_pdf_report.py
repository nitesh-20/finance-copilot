...
class ProfessionalEquityReport:
    ...
    def build_disclaimer_page(self):
        ...
        # 报告信息
        report_info = f"Report Generated: {datetime.now(EASTERN_TZ).strftime('%Y-%m-%d %H:%M')} ET | {self.data.get('research_source', 'Finance Copilot')}"
    ...
    def _add_pdf_metadata(self, canvas_obj, doc):
        ...
        canvas_obj.setAuthor(self.data.get('research_source', 'Finance Copilot'))
        ...
        canvas_obj.setCreator('Finance Copilot Equity Research Platform')
