...
class Finance Copilot(AssistantAgent):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if isinstance(agent_config, str):
            ...
            assert name in library, f"Finance Copilot {name} not found in agent library."
...
class SingleAssistantBase(ABC):
    ...
    def __init__(
        ...
        self.assistant = Finance Copilot(
...
class SingleAssistantShadow(SingleAssistant):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.assistant_shadow = Finance Copilot(
            agent_config,
            toolkits=[],
            llm_config=llm_config,
            proxy=None,
