"""
Finance Copilot Equity Research Module
...
Usage:
    from finance_copilot_equity.core.src.generate_financial_analysis import main as generate_analysis
    from finance_copilot_equity.core.src.create_equity_report import main as create_report
...
__version__ = "0.1.0"
__author__ = "Finance Copilot Developers"
__description__ = "Equity Research Analysis Module for Finance Copilot"
