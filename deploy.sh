...
################################################################################
# Finance Copilot Equity Research - Complete Deployment Script
# 
# This script manages the complete Finance Copilot Equity Research module including:
...
LOG_DIR="${SCRIPT_DIR}/finance_copilot_equity/logs"
mkdir -p "$LOG_DIR"
...
install_deps() {
    ...
    # Note: finance_copilot_equity is a local module, no need to install separately
...
start_app() {
    print_header "Starting Finance Copilot Equity Research Web Application"
    ...
    # Add current directory to PYTHONPATH so finance_copilot_equity can be imported
...
stop_app() {
    print_header "Stopping Finance Copilot Equity Research Web Application"
...
check_status() {
    print_header "Finance Copilot Equity Research Application Status"
...
restart_app() {
    print_header "Restarting Finance Copilot Equity Research Web Application"
...
================================================================================
  Finance Copilot Equity Research - Deployment Script
================================================================================
...
CONFIGURATION:
  API Keys:
    ...
    cp finance_copilot_equity/core/config/config.ini.example \
       finance_copilot_equity/core/config/config.ini
...
LOG FILES:
  Application logs: finance_copilot_equity/logs/app.log
  Task logs:        finance_copilot_equity/logs/task_{id}.log
