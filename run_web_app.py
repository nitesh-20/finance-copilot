#!/usr/bin/env python3
"""
Start the Finance Copilot Equity Research Web Application
...
Usage:
    ...
    Or from the Finance Copilot root directory:
    python -m finance_copilot_equity.run_web_app
"""
...
def run_web_app(host: str = "127.0.0.1", port: int = 8001, reload: bool = True):
    ...
    """
    print("=" * 60)
    print("Finance Copilot Equity Research Web Application")
    print("=" * 60)
    ...
    try:
        ...
        uvicorn.run(
            "finance_copilot_equity.web_app.main:app",
            host=host,
            port=port,
            reload=reload,
            log_level="info"
        ...
        print("  pip install finance_copilot[equity]")
        sys.exit(1)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Start the Finance Copilot Equity Research Web Application"
    )
    parser.add_argument(
        "--host",
        type=str,
