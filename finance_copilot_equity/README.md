...
```bash
cp finance_copilot_equity/core/config/config.ini.template finance_copilot_equity/core/config/config.ini
```
...
| `FINANCE_COPILOT_ADMIN_EMAIL` | `admin@finance_copilot.com` | Initial admin email |
| `FINANCE_COPILOT_ADMIN_PASSWORD` | (random) | Initial admin password |
